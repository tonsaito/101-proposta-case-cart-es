...
import br.com.itau.mastertech.cartoes.invoice.api.model.ExceptionModel;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {CardDoesNotBelongToClientException.class, NoPaymentsToPayException.class})
    protected ResponseEntity<Object> handleBadRequestEntity(
            RuntimeException ex, WebRequest request) {
