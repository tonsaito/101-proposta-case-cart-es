...
import br.com.itau.mastertech.cartoes.invoice.api.config.PaymentFeignConfiguration;
...
@FeignClient(name = "payment-api", configuration = PaymentFeignConfiguration.class)
